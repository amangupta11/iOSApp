...
- (void)presentLogInErrorWithTitle:(NSString *)title message:(NSString *)errorMessage inViewController:(UIViewController *)viewController completion:(void (^)(void))completion;
